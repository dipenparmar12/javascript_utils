 ...
 */
function removeDuplicateByKey(arrObj, key) {
  const arr = []
...
console.log('index.js::335 ', removeDuplicateByKey(arrObjs, 'name'))
console.log('index.js::335 ', removeDuplicateByKey(arrObjs, 'position'))
*/